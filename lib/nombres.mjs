...
// El hash se calcula distinto en cada mundo: node:crypto en los scripts,
// WebCrypto en el navegador. Este módulo lo usan los dos, así que no importa
// ninguno de los dos: cada lado pasa el hash ya calculado.
